// Lucide icons for El Mar Fitness
// Usage: import icons from '@/app/components/icons'
...
export const SaladIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M7 21h10"/><path d="M12 21v-4"/><path d="M12 3c-1.5 0-3-1.5-3-4 0-2 2-3.5 3-6 .5 1.5 1.5 2.5 3 3 0 0-1 1-2 2s-2 2.5-2 4c0 2.5 2 4 4 4h4c2.5 0 4-1.5 4-4 0-1.5-1-2.5-2-4s-2-2-2-2c1.5-.5 2.5-1.5 3-6 0-2.5-1.5-4-3-4Z"/>
  </svg>
);
...
export const RunIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M13.75 22.75 12 22l-3.75-6.25L5 16l7.5-5.25L11 6l3.75 4.5 5.25-8.5L17 10l-3.25 12.75Z"/>
  </svg>
);
