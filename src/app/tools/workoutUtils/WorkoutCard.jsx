...
const WorkoutCard = ({ workout }) => {
  const { day, focus, exercises } = workout;
          ...
          <span className="mr-2">
            {expanded ? (
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M10 6a1 1 0 011 1v6a1 1 0 01-2 0V7a1 1 0 011-1zm4.293.293l-3-3a1 1 0 00-1.414 0l-3 3a1 1 0 001.414 1.414L10 4.414l2.293 2.293a1 1 0 001.414-1.414z"
                  clipRule="evenodd"
                />
              </svg>
            )}
